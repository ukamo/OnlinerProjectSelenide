...
public class PageSearch extends BasePage {
    ...
    private static final String SEARCH_MAIN_XPATH_PATTERN = "//input[contains(@class,'fast-search__input')]";

    private static final int IFRAME_NUMBER_PATTERN = 0;
    private static final String IFRAME_SEARCH_CSS_PATTERN = ".search__close";

    private static final String IFRAME_CLOSE_XPATH_PATTERN = "//span[contains(@class,'search__close')]";
    ...
    public SelenideElement deleteDataInSearchField() {
        $x(format(SEARCH_MAIN_XPATH_PATTERN)).clear();
